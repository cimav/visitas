class VisitsController < ApplicationController
  ...
  private
    ...
    def visit_params
      params.require(:visit).permit(:department_id, :institution, :resp_name, :resp_phone, :resp_email, :requested_date, :transport_type, :status, :date, :reason, :career, :visit_type)
    end
end
