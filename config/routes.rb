Rails.application.routes.draw do
  ...
  get '/visits/confirm_room_visit/:room_visit_id' => 'visits#confirm_room_visit'
  get '/visits/cancel_room_visit/:room_visit_id' => 'visits#cancel_room_visit'
  ...
  get '/change_user/:user_id' => 'sessions#change_user'
end
